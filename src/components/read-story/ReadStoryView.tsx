...
export const ReadStoryView = () => {
  ...
  return (
    <div className="m-5">
      <div className="text-4xl font-bold mb-3">Programming with Streams in Java</div>
      <div className="text-sm text-gray-500 mb-6">Maciej Szarliński · 8 Nov · 20 mins read</div>
